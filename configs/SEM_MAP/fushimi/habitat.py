...
##################################################
dirs = dict(
    output_dir="data/sem_map_sim/{}/{}/{}/{:02}".format(
        scene_name,
        split_name,
        left_right,
        location_idx,
    ),
    data_dir="data/scenes/{}".format(scene_name),
)
...
simulator = dict(
    ...
    # sem-map local scene asset
    scene_id=os.path.join(dirs["data_dir"], "fushimi_rgb.obj"),
    duration=100,  # sec
    FPS=20,
)
